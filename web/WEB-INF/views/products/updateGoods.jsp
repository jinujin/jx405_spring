...
<div class="container">
  <main>
    <form action="/products/updateGoods/${goodsDTO.id}" method="post" enctype="multipart/form-data">
      ...
      <div class="session1 p-3 mb-2">
        <div>
          <ul class="list-group list-group-flush">
            <h4>상품 이름</h4>
            <li class="list-group">
              <input type="text" class="form-control register" id="name" name="name" value="${goodsDTO.name}"
                     placeholder="상품 이름" aria-describedby="goodsName" required>
            </li>
            <h4>상품 가격</h4>
            <li class="list-group">
              <input type="number" class="form-control register" id="price" name="price" value="${goodsDTO.price}"
                     placeholder="상품 가격" required>
            </li>
            <h4>상품 수량</h4>
            <li class="list-group">
              <input type="number" class="form-control register" id="amount" name="amount" value="${goodsDTO.amount}"
            ...
            <li class="list-group">
              <div class="input-group register">
                ...
                <textarea class="form-control" aria-label="With textarea" style="height: 110px;"
                          id="detail" name="detail">${goodsDTO.detail}</textarea>
              </div>
            </li>
